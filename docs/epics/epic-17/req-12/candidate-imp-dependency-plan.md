...
| `EPIC-17-IMP-04` | Delegation Grant representation/history, typed attenuation, authority basis, chain/depth/cycle and revocation. | IMP-03A and IMP-03B accepted | No SubAgent; no raw credential/Memory transfer; fail-closed chain and revocation/admission semantics. |
| `EPIC-17-IMP-05` | Automation stable identity, immutable authored revisions, lifecycle, target and authority-basis references. | IMP-04 accepted | CAS/history/events/outbox and exact target semantics proven; no runtime/scheduler owner duplication. |
