...
| `E17-R07-B01` | No canonical Delegation grant/reference or durable history exists | `E17-R12-C05` | `IMP-04` | `BLOCKS SPECIFIC IMP` | None currently active | [REQ-07](../req-07/contract-deltas-and-adrs.md) |
| `E17-R07-B02` | No typed authority-set/intersection resolver exists | `E17-R12-C05` | `IMP-04` | `BLOCKS SPECIFIC IMP` | None currently active | [REQ-07](../req-07/contract-deltas-and-adrs.md) |
| `E17-R07-B03` | No chain/depth/cycle contract exists | `E17-R12-C05` | `IMP-04` | `BLOCKS SPECIFIC IMP` | None currently active | [REQ-07](../req-07/contract-deltas-and-adrs.md) |
| `E17-R07-B04` | Revocation/expiry enforcement for admitted and active work is not defined in current runtime contracts | `E17-R12-C05` | `IMP-04` | `BLOCKS SPECIFIC IMP` | None currently active | [REQ-07](../req-07/contract-deltas-and-adrs.md) |
| `E17-R07-B05` | Events/Evidence lack a Delegation subject and chain correlation contract | `E17-R12-C08` | `owning IMP + IMP-10` | `BLOCKS SPECIFIC IMP` | None currently active | [REQ-07](../req-07/contract-deltas-and-adrs.md) |
| `E17-R07-B06` | Legacy `canSpawnSubAgents/subAgentScope` metadata can be mistaken for authority | `E17-R12-C05` | `IMP-04` | `BLOCKS SPECIFIC IMP` | None currently active | [REQ-07](../req-07/contract-deltas-and-adrs.md) |
| `E17-R07-B07` | No cross-Tenant Delegation authority contract exists | `E17-R12-C11` | `owning IMP + IMP-10` | `SAFE TO DEFER` | Architecture if excluded boundary is expanded incompatibly | [REQ-07](../req-07/contract-deltas-and-adrs.md) |
...
| `E17-R10-B14` | EPIC-14 IA and current navigation disagree on Administration placement. | `E17-R12-C12` | `IMP-09` | `BLOCKS SPECIFIC IMP` | None currently active | [REQ-10](../req-10/contract-deltas-and-adrs.md) |
...
| `E17-R11-B12` | REQ-10 records unresolved Administration placement in the Control Plane IA. | `E17-R12-C12` | `IMP-09` | `BLOCKS SPECIFIC IMP` | None currently active | [REQ-11](../req-11/contract-deltas-and-adrs.md) |
