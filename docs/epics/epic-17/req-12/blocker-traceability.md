...
| `E17-R10-B14` | EPIC-14 IA and current navigation disagree on Administration placement. | `E17-R12-C12` | `IMP-09` | `RESOLVED / IMP-09 S5 PENDING CTO CLOSURE REVIEW` | Reopens only if Administration regains primary or independent ownership | [IMP-09 conformance](../implementation-gate/imp-09-final-conformance.md) |
...
| `E17-R11-B12` | REQ-10 records unresolved Administration placement in the Control Plane IA. | `E17-R12-C12` | `IMP-09` | `RESOLVED / IMP-09 S5 PENDING CTO CLOSURE REVIEW` | Reopens only if Administration regains primary or independent ownership | [IMP-09 conformance](../implementation-gate/imp-09-final-conformance.md) |
