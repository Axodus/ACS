...
| [IMP-02D Agent Operational Views](imp-02d/README.md) | PARTIAL — bounded, server-scoped Agent Usage records; Runs and Evidence remain unavailable pending bounded Agent-scoped query contracts, and the Agent economics summary is withheld because it ignores Agent scope. |
