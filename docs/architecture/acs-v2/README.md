...
| [IMP-02C Agent Detail & Lifecycle](imp-02c/README.md) | COMPLETE — lifecycle-oriented Agent Overview, explicit revision lineage, Advanced technical context, browser reload, and host regression acceptance using existing Product API contracts only. |
| [IMP-02D Agent Operational Views](imp-02d/README.md) | COMPLETE — Agent-local bounded Runs, Evidence, and Usage & Cost consume the accepted IMP-02D1 contracts, with localhost browser acceptance. Scoped economics projections remain record-context only and do not supply an authoritative cost total. |
| [IMP-02D1 Product API Agent-Scoped Operational Query Compatibility](imp-02d1/README.md) | COMPLETE — bounded server-scoped Agent Runs and Evidence queries, generic Evidence `agentId` forwarding, and scoped economics-summary projections; no read model or frontend completion. |
...
| [EPIC-17 Architecture & Boundary Review and REQ plan](../../epics/epic-17/README.md) | Accepted documentation-only review plus dependency-derived planning sequence; no REQ acceptance or implementation authority. |
...
14. [EPIC-17 Architecture & Boundary Review and REQ plan](../../epics/epic-17/README.md)
