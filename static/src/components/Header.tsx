...
export function Header({getStarted}:{getStarted:string}) {
  ...
  return <header className={`header ${scrolled ? 'scrolled' : ''}`}>
    <a className="brand brand-lockup" href="#top" aria-label="ACS home"><img className="axodus-mark" src="/assets/Axodus_logo.svg" alt="Axodus" /><span className="brand-divider">/</span><span>ACS</span></a>
